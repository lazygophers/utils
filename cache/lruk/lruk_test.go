...
func TestKAccessPromotion(t *testing.T) {
	cache := New[string, int](3, 3) // Need 3 accesses for promotion
...
func TestLRUEviction(t *testing.T) {
	cache := New[string, int](2, 2) // Capacity 2, K=2
...
func TestHistoryManagement(t *testing.T) {
	cache := New[string, int](2, 2) // Small cache to test eviction
