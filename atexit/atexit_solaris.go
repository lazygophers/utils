...
// initSignalHandler initializes signal handler for Solaris/illumos
// 初始化信号处理 - Solaris/illumos系统
func initSignalHandler() {
	signalOnce.Do(func() {
		c := make(chan os.Signal, 1)
		// Monitor standard Unix termination signals
		// Solaris/illumos support full Unix signal set
		// 监听标准 Unix 终止信号
		// Solaris/illumos 支持完整的 Unix 信号集
		signal.Notify(c,
